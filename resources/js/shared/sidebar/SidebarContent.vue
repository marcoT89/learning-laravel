<template>
    <div class="w-64 h-screen overflow-y-auto bg-gray-800">
        <div class="text-orange-400 px-8 py-3">
            <svg
        ...
        <nav class="flex flex-col">
            <div v-for="route of routes" :key="route.name">
                <sidebar-item
                    v-if="!route.children"
                    class="mx-3 mt-1 px-4 py-2 space-x-3 flex items-center text-white focus:bg-gray-900 hover:bg-gray-700 rounded-lg transition duration-150 cursor-pointer"
                    :to="route"
                    :route="route"
                    :exact="route.exact"
...
export default {
    components: { SidebarItemParent, SidebarItem },
